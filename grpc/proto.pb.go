...
const file_proto_proto_rawDesc = "" +
	...
	"\x06Leader\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id2\x88\x02\n" +
	"\aAuction\x12\x1a\n" +
	"\x03Bid\x12\n" +
	".BidAmount\x1a\a.BidAck\x12 \n" +
	"\x06Result\x12\x06.Empty\x1a\x0e.AuctionResult\x125\n" +
...
var file_proto_proto_depIdxs = []int32{
	...
	4, // 4: Auction.ReplicaConnected:input_type -> ReplicaConnection
	7, // 5: Auction.UpdateReplica:input_type -> ReplicaState
	6, // 6: Auction.StartElection:input_type -> ReplicaIdentity
	9, // 7: Auction.ElectionFinished:input_type -> Leader
	1, // 8: Auction.Bid:output_type -> BidAck
	2, // 9: Auction.Result:output_type -> AuctionResult
	7, // 10: Auction.ReplicaConnected:output_type -> ReplicaState
	3, // 11: Auction.UpdateReplica:output_type -> Empty
	8, // 12: Auction.StartElection:output_type -> ElectionResponse
	7, // 13: Auction.ElectionFinished:output_type -> ReplicaState
